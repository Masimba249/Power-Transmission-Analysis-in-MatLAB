% Analysis of the  7-bus power system and 8 Bus System in MatLAB The Techninique used in this case is the Newton Raphson Technique.  

clc
clear all
%% The data is as its provided in the Excel file system. 
% Line Data 
%            From   To    R     X      Y/2
